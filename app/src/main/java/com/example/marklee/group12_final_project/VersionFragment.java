...
import static com.example.marklee.group12_final_project.HouseSettings.ACTIVITY_VERSION;
...
public class VersionFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View res = inflater.inflate(R.layout.fragment_version, container, false);
        ((TextView) res.findViewById(R.id.author_text)).setText("Jean Stein Ko");
        ((TextView) res.findViewById(R.id.version_text)).setText(((HouseSettings)getActivity()).ACTIVITY_VERSION);
        return res;
    }
